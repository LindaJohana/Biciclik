...
public class RegisterUserNew {
    ...
    public RegisterUserNew(UserData user, String phone_number, String address, String selfie, String document_front_photo, String document_back_photo, int economic_savings, int carbon_footprint, String verified, String company, String active) {
        this.user = user;
